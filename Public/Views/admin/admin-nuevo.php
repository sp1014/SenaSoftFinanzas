                    ...
                    <form id="frm-admin" action="?c=admin&a=Guardar" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" id="numero_documento" name="numero_documento" data-parsley-type="number" value="<?php echo $pvd->numero_documento; ?>" class="form-control" required data-validacion-tipo="requerido|min:10" />
                            </div>

                            <div class="form-group col-md-6">
                                <label>Teléfono</label>
                                <input type="number" id="telefono" name="telefono" data-parsley-type="number" value="<?php echo $pvd->telefono; ?>" class="form-control" required data-validacion-tipo="requerido|min:10" />
                            </div>

                            <div class="form-group col-md-6">
                                <label>Correo</label>
                                <input type="email" id="correo" name="correo" value="<?php echo $pvd->correo; ?>" data-parsley-type="email" class="form-control" data-validacion-tipo="requerido|min:10" />
                            </div>
